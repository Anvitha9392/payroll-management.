...
public:
    void menu()
    {
        ...
        cout << "\t\t\t\t\t-------------------------------" << endl;
        cout << "\t\t\t\t\t 1. Enter New Employee's Record" << endl;
        cout << "\t\t\t\t\t 2. Modify an Employee Record" << endl;
        cout << "\t\t\t\t\t 3. Delete an Employee Record" << endl;
        cout << "\t\t\t\t\t 4. Salary Record of an Employee" << endl;
        cout << "\t\t\t\t\t 5. Display an Employee's Record" << endl;
        cout << "\t\t\t\t\t 6. Display Records of all the Employees" << endl;
        cout << "\t\t\t\t\t 7. Exit" << endl;
        cout << "\t\t\t\t\t.................................." << endl;
